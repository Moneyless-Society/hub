...
import { PersonUpdateOneRequiredWithoutPersonalInfoNestedInputSchema } from './PersonUpdateOneRequiredWithoutPersonalInfoNestedInputSchema';
...
export const PIIUpdateInputSchema: z.ZodType<Prisma.PIIUpdateInput> = z.object({
  ...
  person: z.lazy(() => PersonUpdateOneRequiredWithoutPersonalInfoNestedInputSchema).optional()
}).strict();

export default PIIUpdateInputSchema;
