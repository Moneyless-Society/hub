...
export const VolunteerQuestionCreateArgsSchema: z.ZodType<Prisma.VolunteerQuestionCreateArgs> = z.object({
  select: VolunteerQuestionSelectSchema.optional(),
  include: VolunteerQuestionIncludeSchema.optional(),
  data: z.union([ VolunteerQuestionCreateInputSchema,VolunteerQuestionUncheckedCreateInputSchema ]),
}).strict() ;

export default VolunteerQuestionCreateArgsSchema;
