...
export const RoleEditsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.RoleEditsFindUniqueOrThrowArgs> = z.object({
  select: RoleEditsSelectSchema.optional(),
  include: RoleEditsIncludeSchema.optional(),
  where: RoleEditsWhereUniqueInputSchema,
}).strict() ;

export default RoleEditsFindUniqueOrThrowArgsSchema;
