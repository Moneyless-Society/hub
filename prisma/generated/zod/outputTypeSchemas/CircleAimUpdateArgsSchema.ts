...
export const CircleAimUpdateArgsSchema: z.ZodType<Prisma.CircleAimUpdateArgs> = z.object({
  select: CircleAimSelectSchema.optional(),
  include: CircleAimIncludeSchema.optional(),
  data: z.union([ CircleAimUpdateInputSchema,CircleAimUncheckedUpdateInputSchema ]),
  where: CircleAimWhereUniqueInputSchema,
}).strict() ;

export default CircleAimUpdateArgsSchema;
