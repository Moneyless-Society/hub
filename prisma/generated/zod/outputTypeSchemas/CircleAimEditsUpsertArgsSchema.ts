...
export const CircleAimEditsUpsertArgsSchema: z.ZodType<Prisma.CircleAimEditsUpsertArgs> = z.object({
  ...
  create: z.union([ CircleAimEditsCreateInputSchema,CircleAimEditsUncheckedCreateInputSchema ]),
  update: z.union([ CircleAimEditsUpdateInputSchema,CircleAimEditsUncheckedUpdateInputSchema ]),
}).strict() ;

export default CircleAimEditsUpsertArgsSchema;
