...
export const VolunteerResponseUpdateArgsSchema: z.ZodType<Prisma.VolunteerResponseUpdateArgs> = z.object({
  select: VolunteerResponseSelectSchema.optional(),
  include: VolunteerResponseIncludeSchema.optional(),
  data: z.union([ VolunteerResponseUpdateInputSchema,VolunteerResponseUncheckedUpdateInputSchema ]),
  where: VolunteerResponseWhereUniqueInputSchema,
}).strict() ;

export default VolunteerResponseUpdateArgsSchema;
