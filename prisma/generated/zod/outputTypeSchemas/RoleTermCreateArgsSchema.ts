...
export const RoleTermCreateArgsSchema: z.ZodType<Prisma.RoleTermCreateArgs> = z.object({
  select: RoleTermSelectSchema.optional(),
  include: RoleTermIncludeSchema.optional(),
  data: z.union([ RoleTermCreateInputSchema,RoleTermUncheckedCreateInputSchema ]),
}).strict() ;

export default RoleTermCreateArgsSchema;
