...
export const RoleTermFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.RoleTermFindUniqueOrThrowArgs> = z.object({
  select: RoleTermSelectSchema.optional(),
  include: RoleTermIncludeSchema.optional(),
  where: RoleTermWhereUniqueInputSchema,
}).strict() ;

export default RoleTermFindUniqueOrThrowArgsSchema;
