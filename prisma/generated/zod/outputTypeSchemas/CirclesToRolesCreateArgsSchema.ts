...
export const CirclesToRolesCreateArgsSchema: z.ZodType<Prisma.CirclesToRolesCreateArgs> = z.object({
  select: CirclesToRolesSelectSchema.optional(),
  include: CirclesToRolesIncludeSchema.optional(),
  data: z.union([ CirclesToRolesCreateInputSchema,CirclesToRolesUncheckedCreateInputSchema ]),
}).strict() ;

export default CirclesToRolesCreateArgsSchema;
