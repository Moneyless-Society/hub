...
export const CircleAimFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.CircleAimFindUniqueOrThrowArgs> = z.object({
  select: CircleAimSelectSchema.optional(),
  include: CircleAimIncludeSchema.optional(),
  where: CircleAimWhereUniqueInputSchema,
}).strict() ;

export default CircleAimFindUniqueOrThrowArgsSchema;
